                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" id="edit-blood" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control blood_group" id="name" name="name"
                                            placeholder="Blood Group Name" value="{{ $group->name }}" required>
                                    </div>
                                    <input type="submit" id="editGroup" class="btn btn-primary" value="Update">
                                </form>
